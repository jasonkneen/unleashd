  ...
  return (
    <div className="audit-overlay">
      <div className="audit-modal">
        ...
        <p>
          Orchestral acts as a local UI wrapper and orchestrator. It requires the underlying agent
          CLIs to be installed and authenticated on your machine.
        </p>
        ...
        <p className="note">
          You can still use Orchestral, but attempts to route tasks to missing agents will fail.
        </p>
